...
const FromLogin = () => {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(submit)} className="m-auto max-w-[900px]">
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="ml-[27%] mr-[50%] w-[45%] ">
             <div className="relative flex py-2 items-center w-[500px]">
              <Label className="text-[16px] font-bold ml-[14px]">Account</Label>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="ml-[27%] mr-[50%] w-[45%]">
              <div className="relative flex py-2 items-center w-[500px]">
              <Label className="text-[16px] font-bold ml-[14px]">Password</Label>
              <FormMessage className="ml-[10px] mb-1 mt-1 text-[12px]" />
              </div>
              <FormControl>
                <Input
        ...
        />
        <FormDescription className="ml-[62%] mr-[30%] w-[45%] mt-[20px]" > forgot password </FormDescription>
        <Button
          type="submit"
